...
public interface StickyRecyclerFootersAdapter<VH extends RecyclerView.ViewHolder> {
    /**
     ...
     */
    VH onCreateFooterViewHolder(ViewGroup parent);
     ...
     */
    void onBindFooterViewHolder(VH holder, int position);

    VH getFooterViewHolder(int postion);
